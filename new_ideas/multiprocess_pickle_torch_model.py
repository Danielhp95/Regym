...
from rl_algorithms import build_PPO_Agent, build_DQN_Agent, AgentHook
...
def self_play_training_process(queue, end_queue):
    ...
    end_queue.put(AgentHook(agent) )
    end_queue.put(AgentHook(agent2) )
...
if __name__ == '__main__':
    ...
    agent_queue.put(AgentHook(agent) )
    agent_queue.put(AgentHook(agent2) )
